...
public class HitDetection_v1_12_R1 extends HitDetection {

    public HitDetection_v1_12_R1(Plugin plugin, PresetHandler presetHandler) {
    ...
    private void run(EntityPlayer attacker, EntityPlayer damaged) {
        ...
        Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            if(velocityEvent.isCancelled()) {
                damaged.motX = victimMotion.x;
                damaged.motY = victimMotion.y;
                damaged.motZ = victimMotion.z;
            } else {
