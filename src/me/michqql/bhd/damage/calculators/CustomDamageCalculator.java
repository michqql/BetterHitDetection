...
public class CustomDamageCalculator extends AbstractDamageCalculator {
    ...
    public CustomDamageCalculator(Plugin plugin, DamageCalculatorHandler damageCalculatorHandler, PresetHandler presetHandler) {
    ...
    public double calculateDamage(PlayerData attackerData, PlayerData damagedData) {
        ...
        if (baseAttackDamage > 0.0F || sharpnessDamage > 0.0F) {
            ...
            damaged.setFireTicks(80 * fireAspectEnchantmentLevel);
